...
RUN git clone https://github.moeyy.xyz/https://github.com/yfukasawa/LongQC.git $HOME/LongQC
...
RUN conda install -y python=3.9 numpy pandas'>=0.24.0' scipy jinja2 h5py matplotlib'>=2.1.2' scikit-learn
RUN conda install -y -c bioconda --solver=classic edlib pysam python-edlib
